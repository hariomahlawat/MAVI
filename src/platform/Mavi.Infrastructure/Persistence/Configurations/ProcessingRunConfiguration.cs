...
public sealed class ProcessingRunConfiguration : IEntityTypeConfiguration<ProcessingRun>
{
    ...
    {
        builder.ToTable("processing_runs", t =>
        {
        ...
        builder.Property(x => x.DetectorName).HasColumnName("detector_name").HasMaxLength(128);
        builder.Property(x => x.DetectorVersion).HasColumnName("detector_version").HasMaxLength(128);
        builder.Property(x => x.TrackerName).HasColumnName("tracker_name").HasMaxLength(128);
        builder.Property(x => x.TrackerVersion).HasColumnName("tracker_version").HasMaxLength(128);
        builder.Property(x => x.ConfigurationJson).HasColumnName("configuration_json").HasColumnType("jsonb").IsRequired();
        builder.Property(x => x.RuntimeProvenanceJson).HasColumnName("runtime_provenance_json").HasColumnType("jsonb");
        builder.Property(x => x.WorkerId).HasColumnName("worker_id").HasMaxLength(128);
