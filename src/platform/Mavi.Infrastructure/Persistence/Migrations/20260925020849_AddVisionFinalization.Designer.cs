...
namespace Mavi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925020849_AddVisionFinalization")]
    partial class AddVisionFinalization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mavi.Domain.Processing.VisionFinalizationPayload", b =>
                {
                    ...
                    b.HasKey("JobId", "AttemptCount");

                    b.ToTable("vision_finalization_payloads", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_vision_finalization_payloads_length", "payload_length = octet_length(payload) AND payload_length >= 1 AND payload_length <= 50331648");
            ...
            modelBuilder.Entity("Mavi.Domain.Processing.VisionJob", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FinalizationAcceptedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("finalization_accepted_at_utc");

                    b.Property<int>("FinalizationAttemptCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("finalization_attempt_count");

                    b.Property<DateTimeOffset?>("FinalizationClaimExpiresAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("finalization_claim_expires_at_utc");

                    b.Property<DateTimeOffset?>("FinalizationClaimExtendedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("finalization_claim_extended_at_utc");

                    b.Property<byte[]>("FinalizationClaimTokenHash")
                        .HasColumnType("bytea")
                        .HasColumnName("finalization_claim_token_hash");

                    b.Property<string>("FinalizationLastErrorCode")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("finalization_last_error_code");
                    ...
                    b.HasIndex("FinalizationClaimExpiresAtUtc")
                        .HasDatabaseName("ix_vision_jobs_finalizing_claim")
                    ...
                    b.ToTable("vision_jobs", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_vision_jobs_finalization_claim_token_hash", "finalization_claim_token_hash IS NULL OR octet_length(finalization_claim_token_hash) = 32");

                            t.HasCheckConstraint("ck_vision_jobs_finalizing_facts", "status <> 'Finalizing' OR (completion_digest IS NOT NULL AND finalization_accepted_at_utc IS NOT NULL AND lease_owner IS NOT NULL AND lease_token_hash IS NOT NULL AND attempt_count >= 1)");
            ...
            modelBuilder.Entity("Mavi.Domain.Processing.VisionFinalizationPayload", b =>
                {
                    b.HasOne("Mavi.Domain.Processing.VisionJob", null)
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
