...
**Companion:** `2026-09-20-spatial-temporal-track-analytics.md` is the implementation-grade plan for stage 1. Task 18 (`2026-09-18-task-18-phase1-production-qualification-rebaseline.md`) is a separate, parallel qualification stream and is not a stage here.
...
| Scene-configuration revision semantics (whole-configuration revisions, stable ids, activation, empty revision disables analytics) | Accepted in ADR-011 | Stage 1 Slice 0 — done; implemented in Slice 1 |
