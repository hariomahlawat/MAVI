...
- **Lease expiry alone does not invalidate ownership.** A unit whose lease has expired is merely *reclaimable*; ownership is lost at the moment another attempt successfully claims it. An attempt that overruns its lease but was never reclaimed still completes normally, which avoids discarding correct work for a clock margin.
