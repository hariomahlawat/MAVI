...
| ID | Requirement | Status |
|---|---|---|
| B1 | Deterministic four-role candidate selector implemented with documented tie-breaking | OPEN — implemented in S1.2c (not merged); the two-tier Representative awaits ratification of the proposed ADR-013 §4 amendment; evidence pending S1.4 |
