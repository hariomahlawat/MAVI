...
**Accepted as a pre-measurement safety bound.** 50 covered runs matches §Z's required heatmap benchmark. The plan explicitly delegates any increase/removal to Slice 7 measurement.
...
7. **Zero covered runs:** 200 + truthful coverage, no zero chart.
...
10. **Resource guards:** apply bucket/run/grid validation before expensive DB/artifact work.
...
## 7. Final planning gate

**P1:** 0 open.  
**P2:** 0 open after the corrections above.  
