    ...
    try:
        ...
        for variant, item in expected.items():
            variants.append({
                ...
                "workerFlowEvidenceSha256": item["workerFlowEvidenceSha256"],
                "workerPythonSha256": item["workerPythonSha256"],
                "workerEnvironmentSha256": item["workerEnvironmentSha256"],
                "workerVenvRootSha256": item["workerVenvRootSha256"],
                "workerResolvedPythonSha256": item["workerResolvedPythonSha256"],
